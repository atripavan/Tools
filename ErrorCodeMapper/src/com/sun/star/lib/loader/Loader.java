...
public final class Loader {
    ...
    public static void main( String[] arguments ) throws Exception {
            ...
            for ( int i = res.size() - 1; i >= 0; i-- ) {
                ...
                try {
                    ...
                    Attributes attrs = (Attributes) mf.getAttributes(
                        "src/com/sun/star/lib/loader/Loader.class" );
                    if ( attrs != null ) {
                        className = attrs.getValue( "src/com/example/OfficeUNOClientApp" );
                        if ( className != null )
                            break;
                    }
                } catch ( IOException e ) {
        ...
        if ( className == null ) {
            className = System.getProperty("src/com/example/OfficeUNOClientApp");
